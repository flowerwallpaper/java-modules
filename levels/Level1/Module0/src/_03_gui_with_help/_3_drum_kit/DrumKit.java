...
public class DrumKit implements MouseListener {
    ...
    public void run() {
        ...
        String drumImageString = "snare.jpg";
        ...
        drumImagePanel.setLayout(new GridLayout());
